...
public class UsersPanel extends VerticalLayout {
     ...
     * Constructor
     */
    public UsersPanel(final Client client) {	
    ...
    private class DeleteColoumnGenerator implements ColumnGenerator {
        ...
        public Object generateCell(final Table source, final Object itemId, Object columnId) {			 
            ...
            deleteDomainImage.setHeight("16px");
     ...
     */
    private void showConfirmDeletion(String message, final String itemToRemove, final Client jamesClient) {	
     ...
     */
    private void showConfirmEdit(String message, final String userToEdit,final String newPassword, final Client jamesClient) {	
        ConfirmDialog.show(this.getUI(), "Please Confirm:", message, "Yes","No", new ConfirmDialog.Listener() {
            private static final long serialVersionUID = 1L;
            public void onClose(ConfirmDialog dialog) {
                if (dialog.isConfirmed()) {		                	
